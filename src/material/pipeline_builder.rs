...
pub(crate) fn descriptor_type_to_dashi(ty: ShaderDescriptorType) -> BindGroupVariableType {
    match ty {
...
pub struct ShaderVariable {
    pub(crate) allocation: crate::utils::DHObject,
    pub(crate) members: Vec<(String, u32, u32)>,
...
pub struct PSOResource {
    pub(crate) binding: u32,
    pub(crate) variables: Vec<(String, ShaderVariable)>,
}
